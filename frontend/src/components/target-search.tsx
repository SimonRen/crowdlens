...
export function TargetSearchPanel() {
  const { targetActive, targetThreshold, targetThumbnailUrl, setTargetActive, setTargetThreshold, clearTarget: clearTargetStore } = useMonitorStore()
  ...
  }, [targetThreshold, setTargetActive])
